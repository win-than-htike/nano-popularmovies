...
public abstract class CursorRecyclerViewAdapter<VH extends RecyclerView.ViewHolder>
  ...
  public CursorRecyclerViewAdapter(Context context, Cursor cursor) {
    ...
    mRowIdColumn = mDataValid ? mCursor.getColumnIndex(MovieDatabaseContract.Movies._ID) : -1;
  ...
  public Cursor swapCursor(Cursor newCursor) {
    ...
    if (mCursor != null) {
      ...
      mRowIdColumn = newCursor.getColumnIndexOrThrow(MovieDatabaseContract.Movies._ID);
      mDataValid = true;
